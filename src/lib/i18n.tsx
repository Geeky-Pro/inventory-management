...
const dict = {
  ar: {
    ...
    debts: "كشوف حسابات العملاء",
    supplier_statements: "كشوف حسابات الموردين",
    reports: "التقارير",
    ...
    confirm_void_invoice: "هل أنت متأكد من إلغاء هذه الفاتورة؟ سيتم عكس أثرها على المخزون.",
    void_success: "تم إلغاء الفاتورة بنجاح",
    from_date: "من تاريخ",
    to_date: "إلى تاريخ",
    filter: "تصفية",
    all: "الكل",
  ...
  en: {
    ...
    check: "Check",
    other: "Other",
    invalid_amount: "Amount and exchange rate must be greater than zero",
    ...
    confirm_void_invoice: "Are you sure you want to void this invoice? Its inventory effect will be reversed.",
